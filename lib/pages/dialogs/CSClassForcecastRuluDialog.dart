...
class CSClassForcecastRuluDialog extends StatefulWidget{

  CSClassForcecastRuluDialog();

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return CSClassForcecastRuluDialogState();
  }

}

class CSClassForcecastRuluDialogState extends State<CSClassForcecastRuluDialog>{
  var csProMsgList=[
              ...
              Container(
                ...
                child:Column(
                  ...
                  children: <Widget>[
                    ...
                    ListView.builder(
                        shrinkWrap: true,
                        itemCount: csProMsgList.length,
                        physics: NeverScrollableScrollPhysics(),
                        itemBuilder: (c,index){
                          var item =csProMsgList[index];
                          return Container(
