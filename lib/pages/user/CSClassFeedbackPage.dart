...
class CSClassFeedbackPage extends StatefulWidget{
  @override
...
class StateFeedback extends State<CSClassFeedbackPage>{
  String csProContent="";
  @override
        ...
        child: Column(
          children: <Widget>[
            ...
            GestureDetector(
              ...
              onTap: () async {
                if(csProContent.isEmpty){
                  CSClassToastUtils.csMethodShowToast(msg: "提交内容不能为空");
                }else{
                  CSClassApiManager.csMethodGetInstance().csMethodGiveFeedback(context:context,queryParameters: {"content":csProContent,},csProCallBack: CSClassHttpCallBack(
