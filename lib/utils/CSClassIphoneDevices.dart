class CSClassIphoneDevices{


  String csMethodDevicesString(String deivice){
    
 
  if(deivice.startsWith("iPhone")){
    return csMethodIPhonePlatform(deivice);
  }

  if(deivice.startsWith("iPad")){
    return csMethodIPadPlatform(deivice);
  }

  if(deivice.startsWith("iPod")){
    return csMethodIPodPlatform(deivice);
  } 
...
//iPhone设备
String csMethodIPhonePlatform(String deivice){
...
//iPad设备
String csMethodIPadPlatform(String deivice){
...
//iPod设备
String csMethodIPodPlatform(String deivice){
