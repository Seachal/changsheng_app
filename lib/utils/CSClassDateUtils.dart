...
class CSClassDateUtils {


  static bool csMethodIsToday(String date){
  ...
  static String csMethodFormatWeekday(String date){
    String result="";
    DateTime dateTime= DateTime.parse(date);
  ...
  static String csMethodDateFormatByString(String date ,String format){
    DateTime dateTime= DateTime.parse(date);
  ...
  static List<String> csMethodBeforDays(int count,String currentDay){
    List<String> days=[];
  ...
  static List<String> csMethodAfterDays(int count,String currentDay){
    List<String> days=[];
    days.add(currentDay);
    DateTime currentTime= DateTime.parse(currentDay);
    for(var i=1;i<count;i++){
