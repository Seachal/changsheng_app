...
/// [CSClassNestedScrollViewRefreshBallStyle] far enough to demonstrate that they want the app to
/// refresh. The returned [Future] must complete when the refresh operation is
/// finished.
///
/// Used by [CSClassNestedScrollViewRefreshBallStyle.onRefresh].
...
/// always scrollable and, therefore, can trigger the [CSClassNestedScrollViewRefreshBallStyle].
///
/// A [CSClassNestedScrollViewRefreshBallStyle] can only be used with a vertical scroll view.
///
/// See also:
///
///  * <https://material.google.com/patterns/swipe-to-refresh.html>
///  * [CSClassNestedScrollViewRefreshBallStyleState], can be used to programmatically show the refresh indicator.
///  * [RefreshProgressIndicator], widget used by [CSClassNestedScrollViewRefreshBallStyle] to show
///    the inner circular progress spinner during refreshes.
///  * [CupertinoSliverRefreshControl], an iOS equivalent of the pull-to-refresh pattern.
///    Must be used as a sliver inside a [CustomScrollView] instead of wrapping
///    around a [ScrollView] because it's a part of the scrollable instead of
///    being overlaid on top of it.
class CSClassNestedScrollViewRefreshBallStyle extends StatefulWidget {
  /// Creates a refresh indicator.
  ///
  /// The [onRefresh], [child], and [notificationPredicate] arguments must be
  /// non-null. The default
  /// [displacement] is 40.0 logical pixels.
  const CSClassNestedScrollViewRefreshBallStyle({
    Key ?key,
    required this.child,
  ...
  @override
  CSClassNestedScrollViewRefreshBallStyleState createState() =>
      CSClassNestedScrollViewRefreshBallStyleState();
}

/// Contains the state for a [CSClassNestedScrollViewRefreshBallStyle]. This class can be used to
/// programmatically show the refresh indicator, see the [show] method.
class CSClassNestedScrollViewRefreshBallStyleState
    extends State<CSClassNestedScrollViewRefreshBallStyle>
    with TickerProviderStateMixin<CSClassNestedScrollViewRefreshBallStyle> {
  AnimationController ?_positionController;
  Animation<double> ?_positionFactor;

  Animation<Color?> ?_valueColor;
  AnimationController ?csProControllerLoading;
...
// 更新时间
  DateTime ?_dateTime;
  /// 更多信息
  final String csProInfoText="最后更新时间 %T";
  // 获取更多信息
  ...
  @override
  void dispose() {
    if(csProControllerLoading!=null){
  ...
  ///
  /// Creating the [CSClassNestedScrollViewRefreshBallStyle] with a [GlobalKey<RefreshIndicatorState>]
  /// makes it possible to refer to the [CSClassNestedScrollViewRefreshBallStyleState].
  ///
  /// The future returned from this method completes when the
  /// [CSClassNestedScrollViewRefreshBallStyle.onRefresh] callback's future completes.
  ///
