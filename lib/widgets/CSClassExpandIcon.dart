...
class CSClassExpandIcon extends StatefulWidget {
  /// Creates an [CSClassExpandIcon] with the given padding, and a callback that is
  /// triggered when the icon is pressed.
  const CSClassExpandIcon({
    Key? key,
  ...
  @override
  _CSClassExpandIconState createState() => _CSClassExpandIconState();
}

class _CSClassExpandIconState extends State<CSClassExpandIcon> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(CSClassExpandIcon oldWidget) {
