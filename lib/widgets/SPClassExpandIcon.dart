...
class SPClassExpandIcon extends StatefulWidget {
  /// Creates an [SPClassExpandIcon] with the given padding, and a callback that is
  /// triggered when the icon is pressed.
  const SPClassExpandIcon({
    Key? key,
  ...
  @override
  _SPClassExpandIconState createState() => _SPClassExpandIconState();
}

class _SPClassExpandIconState extends State<SPClassExpandIcon> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(SPClassExpandIcon oldWidget) {
    ...
    return Semantics(
      child: Container(
        ...
        child: RotationTransition(
          turns: _iconTurns!,
          child:  Icon(Icons.expand_more,color: _iconColor,size:widget.size ,),
        ),
      ),
    );
  }
